...
# Form implementation generated from reading ui file 'interfaces/color_settings.ui'
#
...
"")
        ...
        self.HDoubleSpinBox = QtWidgets.QDoubleSpinBox(self.hsv)
        self.HDoubleSpinBox.setAlignment(QtCore.Qt.AlignCenter)
        self.HDoubleSpinBox.setMaximum(360.0)
        self.HDoubleSpinBox.setObjectName("HDoubleSpinBox")
        self.horizontalLayout_4.addWidget(self.HDoubleSpinBox)
        ...
        self.SspinBox.setProperty("value", 100)
        ...
        self.VspinBox.setProperty("value", 100)
